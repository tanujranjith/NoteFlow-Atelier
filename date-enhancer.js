(function () {
    ...
    function setPanelDirection(component) {
        ...
        const rect = component.wrapper.getBoundingClientRect();
        const panelHeight = component.panel.offsetHeight || 340;
        const spaceBelow = window.innerHeight - rect.bottom;
        const spaceAbove = rect.top;
        if (spaceBelow < panelHeight + 16 && spaceAbove > panelHeight + 16) {
    ...
    function patchInputValueSetter() {
        if (valuePatched || typeof HTMLInputElement === 'undefined') return;
        valuePatched = true;
        try {
